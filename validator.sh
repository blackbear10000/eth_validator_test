...
case "$COMMAND" in
    ...
    diagnose-vault-web3signer-keys)
        echo "🔍 诊断 Vault-Web3Signer 密钥格式问题..."
        python3 "$SCRIPT_DIR/scripts/diagnose_vault_web3signer_keys.py"
        ;;
    
    fix-web3signer-network-config)
        echo "🔧 修复 Web3Signer 网络配置问题..."
